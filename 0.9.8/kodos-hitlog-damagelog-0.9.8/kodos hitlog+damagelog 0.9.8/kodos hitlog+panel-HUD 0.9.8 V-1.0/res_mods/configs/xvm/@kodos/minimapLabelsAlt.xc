 ...
 */
{
  "labels": {
      ...
      "units": {
        ...
        "format": {
          "ally":  "<span class='mm_a'><i>{{name%.10s}}</span>",
          "enemy": "<span class='mm_e'><b>{{name%.10s}}<b></span>",
          "squad": "<textformat leading='-1'><span class='mm_s'><i>{{name%.10s}}</i></span><textformat>",
          "lost":  "<span class='mm_dot'>•</span><span class='mm_l'>{{name%.10s}}</span>",
          "oneself": "",
          "lostally":       "<span class='mm_dot'>•</span><span class='mm_la'>{{name%.10s}}</span>",
          "lostteamkiller": "",
